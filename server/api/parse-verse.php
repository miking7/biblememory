...
PROMPT;
  ...
  $requestData = [
    ...
    'max_tokens' => 10000,  // Increased from 1500 to handle longer passages
    'system' => $systemPrompt,
    'messages' => [
      [
        'role' => 'user',
  ...
  if (preg_match('/\{[\s\S]*\}/', $content, $matches)) {
    ...
    if (!$parsed) {
      throw new Exception('Failed to parse JSON from AI response - ' . $content);
    }
