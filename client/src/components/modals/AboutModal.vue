<template>
  <BaseModal :show="show" label="About Bible Memory" @close="$emit('close')">
    ...
    <p class="text-xs text-slate-500 mb-6 leading-relaxed">
      Bible translations are the work of their respective publishers, gratefully acknowledged.
      <a
        href="/bible-copyrights.html"
        target="_blank"
        rel="noopener noreferrer"
        class="text-blue-600 hover:text-blue-700 font-medium whitespace-nowrap">Bible copyrights &amp; credits &rarr;</a>
    </p>
